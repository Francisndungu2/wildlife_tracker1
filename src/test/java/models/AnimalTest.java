...
public class AnimalTest {
    ...
    public void getAnimal_age() {
        ...
        assertEquals("34",newAnimal.getAnimal_age());
    }

    @Test
    public void setanimal_age() {
        Animal newAnimal = Animal.setUpNewAnimal();
        newAnimal.setAnimal_age("34");
        assertEquals("34",newAnimal.getAnimal_age());
    }
    ...
    public void getName() {
        Animal newAnimal = Animal.setUpNewAnimal();
        assertEquals("Zebra",newAnimal.getAnimal_name());
    }
    ...
    public void equals() {
        ...
        assertEquals(newAnimal,newAnimal.findById(newAnimal.getId()));
